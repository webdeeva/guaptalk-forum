      ...
      return iter(guard((context != null) ? context['users'] : null), function each(key0, index, length, value) {
        ...
        return "\n<div data-uid=\"" + 
          ...
          iter(guard((context != null && context['users'] != null && context['users'][key0] != null) ? context['users'][key0]['groups'] : null), function each(key1, index, length, value) {
            var key = key1;
            return "\n<div class=\"group-card float-start m-1\" data-group-name=\"" + 
              ...
              "/admin/manage/groups/" + 
              __escape(guard((context != null && context['users'] != null && context['users'][key0] != null && context['users'][key0]['groups'] != null && context['users'][key0]['groups'][key1] != null) ? context['users'][key0]['groups'][key1]['slug'] : null)) + 
              "\"><span class=\"badge p-2\" style=\"color:" + 
              ...
              " <i class=\"ms-2 remove-group-icon fa fa-times\" role=\"button\"></i></span></a>\n</div>\n";
          }, function alt() {
            return "";
          }) + 
          "\n</div>\n<input data-uid=\"" + 
